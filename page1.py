...
class Chapter1(Button):
    def __init__(self, stack):
        ...
        self.chapter2=Chapter2() # Chapter2 불러오기

        self.btn_chapter1 = QPushButton("next", self) # 버튼 생성
        self.btn_chapter1.setGeometry(50,50,250,100) # 버튼 크기 조절
        self.btn_chapter1.clicked.connect(self.on_click_chapter1) # on_click_chapter1 함수에 연결
