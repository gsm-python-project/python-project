...
class Chapter2(Button):
    def __init__(self, stack):
        ...
        self.cri_slct = ClickableLabel("image1.png", self) # 버튼 생성, 범인 선택하기를 누르면 다른 버튼들이 안 보이고 범인을 선택하는 창이 나타남.
        # self.cri_slct.hide()
        ...
        self.btn_next_Ending = ClickableLabel("image1.png", self) # 버튼 생성, 범인을 클릭할 시에 나타남.
